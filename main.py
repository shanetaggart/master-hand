...
async def on_message(message):
    ...
    if message.content.startswith("mh:help"):
        ...
        help_message_commands = [
            ...
            "- `mh:setconfig` - Sets a value to a key in the configuration JSON. If the key exists, the value will be updated. If the key does not exist, it will be created. Use `mh:checkconfig` to see the current configuration.\n",
